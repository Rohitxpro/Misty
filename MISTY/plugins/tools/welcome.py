...
def welcomepic(pic, user, chatname, id, uname):
    background = Image.open("MISTY/assets/wel2.png")
    pfp = Image.open(pic).convert("RGBA")
    pfp = circle(pfp)
    pfp = pfp.resize((825, 824))
    draw = ImageDraw.Draw(background)
    font = ImageFont.truetype('MISTY/assets/font.ttf', size=40)
    welcome_font = ImageFont.truetype('MISTY/assets/font.ttf', size=60)
...
💥️ 𝐖𝐞𝐥𝐜𝐨𝐦𝐞 𝐓𝐨 › 𝐃ҽѵíl 𝐃ҽcմs 𝐀ղժ 𝐂ɦɑʈʈɪŋʛ 𝐇ʋβ
...
🌹 𝐓𝐡𝐞𝐧 𝐃𝐌 𝐓𝐨: ⏤‌ 🇩 𝐞𝐯𝐢𝐥𝐞𝐚𝐫𝐬 🇴 𝐰𝐧𝐞𝐫 🥀|🇼 𝐡𝐢𝐭𝐞😎⃝🇩 𝐞𝐯𝐢𝐥**
""",
